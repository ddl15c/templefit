  ...
  <div class="slider-main">
    ...
    <div class="slider-wrapper theme-default">
      ...
      <div id="htmlcaption<?php echo esc_attr($val); ?>" class="nivo-html-caption">
        ...
        <div class="slidebtn"><a href="<?php echo $complete['slide_link'.$val]; ?>"><?php echo $complete['slide_btn'.$val]; ?></a></div>
        <?php } ?>        
      </div>
      <?php } ?>
    </div>
    ...
    <div class="slider-wrapper slide-temp theme-default">
      ...
      <div id="htmlcaption" class="nivo-html-caption">
        <div class="title"><?php echo 'it’s not <span style="color:#11bcf4;">just</span> fitness it’s a <strong>lifestyle</strong>'; ?></div>
        <div class="slidedesc"><?php echo 'Donec pellentesque efficitur magna quis rutrum. Nullam porttitor, urna vel efficitur vestibulum....'; ?></div>
      </div>
      <?php } ?>
    </div>
    <?php } ?>
