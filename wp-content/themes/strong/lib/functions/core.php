...
function complete_widgets_init(){
	...
	'name'          => __('Page Sidebar', 'strong'),
	'id'            => 'sidebar-page',
	'description'   => __('When you assign widgets to this area, it will be displayed on all pages.', 'strong'),
	'before_widget' => '<div class="clear"></div></div><div id="%1$s" class="widget %2$s" data-widget-id="%1$s"><div class="widget_wrap">'.$editbutton,
	'after_widget'  => '</div></div>',
	'before_title'  => '<h3 class="widget-title">',
	'after_title'   => '</h3><div class="widgets_padding">'
	));
	
	register_sidebar(array(
	'name'          => __('Blog Sidebar', 'strong'),
	'id'            => 'sidebar-blog',
	'description'   => __('When you assign widgets to this area, it will be displayed on all posts and blog.', 'strong'),
	'before_widget' => '<div class="clear"></div></div><div id="%1$s" class="widget %2$s" data-widget-id="%1$s"><div class="widget_wrap">'.$editbutton,
	'after_widget'  => '</div></div>',
	'before_title'  => '<h3 class="widget-title">',
	'after_title'   => '</h3><div class="widgets_padding">'
	...
	register_sidebar( array(
		'name'          => __( 'Header Right Widget', 'strong' ),
		'description'   => __( 'Appears on header', 'strong' ),
		'id'            => 'headerright',
		'before_widget' => '<div class="right widg">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>',
	) ); 
	...
	register_sidebar( array(
		'name'          => __( 'Footer 1 Column', 'strong' ),
		'description'   => __( 'Appears on footer 1 columns', 'strong' ),
		'id'            => 'footer-1',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 2 Columns', 'strong' ),
		'description'   => __( 'Appears on footer 2 columns', 'strong' ),
		'id'            => 'footer-2',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 3 Columns', 'strong' ),
		'description'   => __( 'Appears on footer 3 columns', 'strong' ),
		'id'            => 'footer-3',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 4 Columns', 'strong' ),
		'description'   => __( 'Appears on footer 4 columns', 'strong' ),
		'id'            => 'footer-4',
		'before_widget' => '<div id="%1$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
...
function complete_excerpt_more($more) {
	return '<br><a class="moretag" href="'. get_permalink() . '">'.__('+ Read More', 'strong').'</a>';
}
...
function complete_more_link( $more_link, $more_link_text ) {
	return str_replace( $more_link_text, __('+ Read More', 'strong'), $more_link );
}
...
function complete_search_form( $form ) {
    ...
    <div>
    <input placeholder="' . __( 'Search &hellip;', 'strong' ) . '" type="text" value="' . get_search_query() . '" name="s" id="s" />
    <input type="submit" id="searchsubmit" value="'. __( 'Search', 'strong' ) .'" />
    </div>
    </form>';
...
function complete_comment($comment, $args, $depth) {
   ...
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div class="comm_edit"><?php edit_comment_link(__('Edit', 'strong'),'','') ?></div>
      
      
      <div class="comment-author vcard">
            <div class="avatar"><?php echo get_avatar($comment,$size='30' ); ?></div>
            <div class="comm_auth"><?php printf(__('%s', 'strong'), get_comment_author_link()) ?></div>
      ...
      <?php if ($comment->comment_approved == '0') : ?>
         <em><?php _e('Your comment is awaiting moderation.', 'strong') ?></em>
         <br />
      <?php endif; ?>
...
$GLOBALS['comment'] = $comment; ?>
   ...
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div id="comment-<?php comment_ID(); ?>" class="comment-body">
           <?php edit_comment_link(__('Edit', 'strong'),'  ','') ?>
      <?php if ($comment->comment_approved == '0') : ?>
         <em><?php _e('Your comment is awaiting moderation.', 'strong') ?></em>
         <br />
      <?php endif; ?>
      ...
      <div class="org_ping">
      	<?php printf(__('<cite class="citeping">%s</cite> <span class="says">:</span>', 'strong'), get_comment_author_link()) ?>
	  	<?php comment_text() ?>
...
function complete_comment_form_fields($fields){
	...
	$fields['author'] = '<div class="comm_wrap"><p class="comment-form-author"><input placeholder="' . __( 'Name', 'strong' ) . '" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .'" size="30"' . $aria_req . ' /></p>';

	$fields['email'] = '<p class="comment-form-email"><input placeholder="' . __( 'Email', 'strong' ) . '" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) .'" size="30"' . $aria_req . ' /></p>';

	$fields['url'] = '<p class="comment-form-url"><input placeholder="' . __( 'Website', 'strong' ) . '" id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) .'" size="30" /></p></div>';
    return $fields;
}
