...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'strong' ),
		'cyrillic'     => __( 'Cyrillic', 'strong' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'strong' ),
		'devanagari'   => __( 'Devanagari', 'strong' ),
		'greek'        => __( 'Greek', 'strong' ),
		'greek-ext'    => __( 'Greek Extended', 'strong' ),
		'khmer'        => __( 'Khmer', 'strong' ),
		'latin'        => __( 'Latin', 'strong' ),
		'latin-ext'    => __( 'Latin Extended', 'strong' ),
		'vietnamese'   => __( 'Vietnamese', 'strong' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'strong' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'strong' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'strong' ),
