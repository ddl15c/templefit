...
//========================= ADD SECTIONS==============================
        ...
        $wp_customize->add_section( 'pageheader_section', array(
            'title'       => __( 'Page Header Settings', 'strong' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => __( 'To view the live changes you make in this section, select a page from the Top bar dropdown list located at the top right corner of the screen.', 'strong' ),
        ) );	
		
        $wp_customize->add_section( 'postheader_section', array(
            'title'       => __( 'Post Header Settings', 'strong' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => '',
        ) );		
        ...
        $wp_customize->add_section( 'blogpage_section', array(
            'title'       => __( 'Blog Page Settings', 'strong' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => __( 'Applies only to the page created with the Blog Page Template (Setting up a Blog Page).', 'strong' ),
        ) );
		
        $wp_customize->add_section( 'contactpage_section', array(
            'title'       => __( 'Contact Page Settings', 'strong' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => '',
        ) );
        ...
        $wp_customize->add_section( 'socialshare_section', array(
            'title'       => __( 'Social Share Buttons', 'strong' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => __( 'To view the live changes you make in this section, select a post or a page from the Top bar dropdown list located at the top right corner of the screen.', 'strong' ),
        ) );
		
        $wp_customize->add_section( 'footercolors_section', array(
            'title'       => __( 'Footer Style', 'strong' ),
            'priority'    => 10,
            'panel'       => 'footer_panel',
        ) );
		
        $wp_customize->add_section( 'footer_columns_section', array(
            'title'       => __( 'Footer Columns', 'strong' ),
            'priority'    => 10,
            'panel'       => 'footer_panel',
        ) );		

        $wp_customize->add_section( 'copyright_section', array(
            'title'       => __( 'Copyright Area', 'strong' ),
            'priority'    => 10,
            'panel'       => 'footer_panel',
        ) );
		
        $wp_customize->add_section( 'miscmedia_section', array(
            'title'       => __( 'Media Settings', 'strong' ),
            'priority'    => 10,
            'panel'       => 'misc_panel',
			'description' => __( 'Meida Settings', 'strong' ),
        ) );
